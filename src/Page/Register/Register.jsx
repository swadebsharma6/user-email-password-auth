        ...
        <form onSubmit={handleRegister} className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          ...
          <div className="flex flex-col gap-4 p-6">
            ...
            <div className="relative h-11 w-full min-w-[200px]">
              ...
              {/*span */}
              <span className="absolute btn" onClick={()=>setShowPass(!showPass)}>       
            {
              showPass ? <AiFillEyeInvisible className="text-2xl"></AiFillEyeInvisible> : <AiFillEye className="text-2xl"></AiFillEye>
            }
             </span>
            </div>
